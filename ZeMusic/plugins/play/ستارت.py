...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/SOURCE_SOM3A) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/SOURCE_SOM3A) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/SOURCE_SOM3A)\n [𝗦𝗼𝗨𝗿𝗖𝗲 𝗦𝗼𝗠𝟯𝗮](https://t.me/SOURCE_SOM3A)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/SOURCE_SOM3A) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/YR_HC"),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/SOURCE_SOM3A) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/SOURCE_SOM3A) \n ※[These Features AI Based](https://t.me/SOURCE_SOM3A)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="SOURCE_SOM3A"),
                ...
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/Y_D_ll"
                    )
                ],
            ]
        ),
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع زد إي من هن : @SOURCE_SOM3A **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
